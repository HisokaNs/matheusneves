window.onload = function () { 
    ...
    const bttn3 = document.getElementById("bttn3") ? document.getElementById("bttn3") : '';
    ...
    if(bttn2 != '')
    {
        bttn2.addEventListener("click", function() {
            entrada.innerHTML = "Entrada: " + inputText.value;
            resultado.innerHTML = "resultado: " + marcaVogais(inputText.value);
        });
    }
    ...
    if(bttn5 != '')
    {
        bttn5.addEventListener("click", function() {
            entrada.innerHTML = "Entrada: " + inputText.value;
            resultado.innerHTML = "resultado: " + subistituiTexto(inputText.value, inputTextSearch.value, inputTextChange.value);
        });
    }
    ...
    if(bttn9 != '')
    {
        bttn9.addEventListener("click", function() {
            let textresultado = classificaTexto(inputTextarea.value);
    ...
    if(bttn10 != '')
    {
        bttn10.addEventListener("click", function() {
            entrada.innerHTML = "Entrada: " + inputText.value;
            resultado.innerHTML = "resultado: " + aplicaCriptografiaTenisPolar(inputText.value);
        });
    }
